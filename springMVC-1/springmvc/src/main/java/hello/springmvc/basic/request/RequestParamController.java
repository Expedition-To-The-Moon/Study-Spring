...
public class RequestParamController {
     ...
     * 주의! /request-param-required?username= -> 빈문자로 통과 가능
     * 주의! /request-param-required
     * int age -> null을 int에 입력하는 것은 불가능, 따라서 Integer(객체형이므로) 변경해야 함
     * 또는 다음에 나오는 defaultValue 사용 */
    @ResponseBody
    @RequestMapping("/request-param-required")
    public String requestParamRequired( // required = true -> 필수 조건(true가 기본값)
     ...
     *  참고: defaultValue는 빈 문자의 경우에도 적용 가능
     ...
     *  argument resolver 로 지정해둔 타입 제외 => @ModelAttribute */
    @ResponseBody
